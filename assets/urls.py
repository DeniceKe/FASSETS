...
urlpatterns = [
    ...
    path("tracking/", views.asset_tracker, name="asset_tracker"),
    path("workspace/<slug:resource>/", views.workspace_resource, name="workspace_resource"),
    path("assets/", views.asset_list, name="asset_list"),
    path("assets/<int:asset_id>/qr-label/", views.asset_qr_label, name="asset_qr_label"),
    path("assets/<int:asset_id>/qr-image/", views.asset_qr_image, name="asset_qr_image"),
